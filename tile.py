...
class tile():
    ...
    def print_detailed_info(self, ):
            ...
            if self.tile_type == "default":
                sg.popup(
                    ...
                    f"""This is a regular tile with an elevation of {self.tile_height}.
    Horizontal Laser Beam: {self.hori_laser}, Vertical Laser Beam: {self.vert_laser}, Cross Laser Beam: {self.cross_laser}
    ...
    """,
                ...
                sg.popup(
                    f"There's an obvious booby trap on this tile.  Don't move here without protection! It has an elevation of {self.tile_height}",
                    keep_on_top=True,
                )
                ...
                sg.popup(
                    f"This is mystery box tile!  A random effect (can be bad or good) will occur when you step here.  It has an elevation of {self.tile_height}",
                    keep_on_top=True,
                )
                return f"This is mystery box tile!  A random effect (can be bad or good) will occur when you step here.  It has an elevation of {self.tile_height}"
